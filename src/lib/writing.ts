...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "<strong>The first is that your first version does not get published.</strong> It gets three passes before anybody sees it. Three is the floor and not the ceiling. This is not perfectionism. Perfectionism has no exit, it keeps you circling because you are afraid of being judged. A pass with a job in it has an exit, because you can see when the job is done. Go past three as often as the work asks. Never go under." },
      ...
      { type: "paragraph", text: "It shows up as subtraction more than addition. What you lead with, what you cut, the obvious line you refuse to write because everybody writes it. So put one question before the three passes. What in this could only have come from me. If the honest answer is nothing, you have assembled the thing rather than made it, and no number of passes will make it yours." },
      { type: "paragraph", text: "The video in this piece is the example. Four rounds, because three did not get there. The tool did the animating every time, and not once did it decide that the subject should be one poster made twelve times, or that the compounding should be shown as two lines pulling apart rather than said in a sentence. Those were my calls, and they are the only reason the thing is about anything. Take them out and you have another competent video about excellence that nobody needed." },
