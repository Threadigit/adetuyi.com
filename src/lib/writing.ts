...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "I consider both of them gifts from God. They are not the only ingredients required for success, but they have become my personal formula for navigating uncertainty." },
      ...
      { type: "paragraph", text: "Curiosity and resilience are what kept all of them growing." },
      { type: "paragraph", text: "One keeps me teachable. The other keeps me moving. One corrects the course. The other supplies the strength to finish it." },
      { type: "paragraph", text: "They shaped the student building solutions to the problems in front of him, the engineer learning product and growth, the operator learning to work at scale, and the entrepreneur now learning to build teams, institutions and systems." },
      { type: "paragraph", text: "I consider them gifts. I also consider them responsibilities, because gifts are meant to be cultivated, directed, and spent on something larger than yourself." },
      { type: "paragraph", text: "If I had to reduce most of my journey to two ingredients, it would be these." },
