...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "That is raw export, and no tool is going to fix it. Two rules do. The rest has to come from you." },
      {
        type: "video",
        url: "/one-shot.mp4",
      ...
      { type: "heading", text: "One. Never publish the first version" },
      { type: "paragraph", text: "Your first version gets three passes before anybody sees it. Three is where it starts, not where it stops. This is not perfectionism. Perfectionism has no exit. It keeps you circling because you are afraid of being judged. A pass with a job has an exit because you can see when that job is done. Go past three as often as the work asks. Never go under." },
      { type: "paragraph", text: "They have to be three different passes. Three rounds of moving commas is one pass repeated. First, structure. Is this the right shape? Then argument. Does it hold? Finally, surface. Check the font, spacing and the line one word too long. It runs the same on a term sheet, a sermon, a product demo or a pull request. Most people never see the distance between version one and version three because they never make version three. Then they compare their first attempt with somebody else's third and conclude the other person is more talented." },
      { type: "heading", text: "Two. Improve the repetition" },
      { type: "paragraph", text: "Treat every repetition as an improvement on the one before it. The same weekly report, minus the section nobody reads. The same pitch, minus the slide that made three prospects go quiet. The same invoice, standup or onboarding call. This is where teams leak, not in the big rebuild everybody can see, but in the fifty repetitions nobody thought to examine. One caution. Not every recurring task deserves improvement. Some deserve deletion. Perfecting a report nobody reads is the most expensive form of diligence there is." },
      { type: "paragraph", text: "Standardisation is often treated as an end state. Work out the right way, write it down, freeze it. A standard is not a finish line. It is a checkpoint where you deposit what you learned so the next person does not have to learn it again. Optimisation carries on underneath. When it produces something better, the standard moves." },
      { type: "paragraph", text: "Writing it down is the line between an excellent person and an excellent culture. An individual running both rules gets better alone. A culture gets better when the improvement survives handoff. Put the lesson into the template. Otherwise, when the person leaves, somebody else restarts at week one and capable people repeat discovery instead of compounding it." },
      { type: "heading", text: "The part no process can supply" },
      { type: "paragraph", text: "Both rules are refinement, and refinement has no direction of its own. Passes make a thing sharper. They cannot tell you what it should have been. That comes from what you have seen, built and got wrong at your own expense. No process produces it. Not novelty. Not style. The mark of the person who made it." },
      { type: "paragraph", text: "You can feel where it is missing. The deck anyone with the same five references would have produced. The report that could have carried any of four names at the bottom. The sermon that says a true thing in the order it is always said. None of it is wrong. It is just nobody's." },
      { type: "paragraph", text: "It shows up in the choices. What you lead with, what you cut, the obvious line you refuse to write because everybody writes it. So put one question before the three passes. What in this could only have come from me. If the honest answer is nothing, you have assembled the thing rather than made it, and no number of passes will make it yours." },
      { type: "paragraph", text: "The video in this piece is the example. Four passes, because three did not get there. The tool did the animating every time, and not once did it decide that the subject should be one poster made twelve times, or that the compounding should be shown as two lines pulling apart rather than said in a sentence. Those were my calls, and they are the only reason the thing is about anything. Take them out and you have another competent video about excellence that nobody needed." },
      { type: "paragraph", text: "This matters more now because AI did not invent one-shot work. It made it free. The cost of producing something that looks finished fell to nothing. Volume exploded, and hardly any of it has had a second pass. The tools raised the floor, a real gain for anyone who could never afford a designer, but a raised floor is not a standard. It is a starting line everybody shares, which is why standing on it is worth nothing." },
      { type: "paragraph", text: "That is what these tools are, multipliers. Point one at a careless process and you get carelessness at scale and at speed. Point it at a disciplined one and you get three passes in the time you used to spend on one. It does not hand you taste you never had. It exports the taste you already have, for everyone to see. Take away the excuse of time and what is left standing is a person's actual standard." },
      { type: "paragraph", text: "Bring the part only you could have brought. Three passes before it ships. Every repetition better than the last one. Bank what you learn so the next person starts where you stopped." },
      { type: "paragraph", text: "That is not a productivity system. It is what it now costs to be worth somebody's time." },
    ]
  },
  {
    ...
    content: [
      { type: "paragraph", text: "Sound judgement needs method. Keep your numbers honestly, study how the last cycle ended and follow what is moving now. I set out that process in <a href=\"/writing/sound-judgement-when-the-rules-keep-changing\" class=\"link-hover text-accent\">Making Sound Judgement When the Rules Keep Changing</a>. But sometimes you do all of that and the answer still does not come." },
      { type: "paragraph", text: "That is not always a sign that you executed badly. Method sharpens how you read a situation. It cannot tell you what to stand on when the reading is not enough. Three things can." },
      { type: "image", url: "/three-ingridients.png", width: 1500, height: 1253, alt: "Three ingredients for sound judgement. When the rules keep changing, sound judgement does not come from knowing more rules. It comes from a combination of three things. 1 Principles, a steady foundation. Principles give you a stable reference point when the details change, and help you stay anchored even when the environment is uncertain. The fear of the Lord is the beginning of wisdom, Proverbs 9:10. 2 Discernment, sensitivity to context. Discernment helps you understand what the moment actually requires, and read people, patterns and timing beyond surface information. But solid food is for the mature, for those who have their powers of discernment trained by constant practice to distinguish good from evil, Hebrews 5:14. 3 The Holy Spirit, divine guidance. The Holy Spirit gives clarity, wisdom and direction that goes beyond human logic, helps you see what others miss, and confirms what to do next. But when He, the Spirit of truth, comes, He will guide you into all the truth, John 16:13.", caption: "Principles. Discernment. The Holy Spirit." },
      ...
      { type: "paragraph", text: "<strong>Divine guidance.</strong> The Holy Spirit gives clarity, wisdom and direction beyond human logic. Bring the decision to Him plainly, before the meeting rather than after the loss, and wait for the settled answer instead of the anxious one. Then test what you sense against Scripture, principle, evidence and trusted counsel. Certainty alone does not make guidance sound." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Now hold your own work against that. Your market changes its rules mid-game, and your biggest calls get judged two or three years later, if ever. By then you have changed nine other things and can credit whichever one flatters you. Nobody tells you what the other road paid." },
      ...
      { type: "paragraph", text: "When American intelligence ran a tournament to find out who forecasts best, civilians working from public news beat analysts holding classified files by more than thirty per cent. The winners were not the ones with the strongest theory. They were scored repeatedly and changed their minds in small steps as conditions moved. The more the ground shifts, the less your strong opinions are worth and the more your corrections are." },
      ...
      { type: "paragraph", text: "I built <a href=\"https://www.chroniclesofinnovation.com/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Chronicles of Innovation</a> to study the historical blueprints and use the <a href=\"https://zerotoact.com/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">ZeroToAct</a> Weekly Intelligence Brief to track what is moving now. I apply the same discipline to what we build, what I fund and what I let wait. Judgement that is never priced stays an opinion." },
      ...
      { type: "callout", text: "Sources include the <a href=\"https://sec.gov.ng/documents/1458/SEC_Nigeria_Recapitalisation_Policy_Briefing.pdf\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">SEC recapitalisation briefing</a>, historical Central Bank of Nigeria records, and <a href=\"https://www.iarpa.gov/newsroom/article/iarpa-announces-publication-of-data-from-the-good-judgment-project\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">IARPA's Good Judgment Project archive</a>. The longer argument about binding constraints is in <a href=\"/writing/effort-at-the-wrong-level\" class=\"link-hover text-accent\">Effort at the Wrong Level</a>." },
    ]
  },
  {
    ...
    ogImage: "/high-cost-consumer-og.jpg",
    readingTime: "6 min read",
    content: [
      ...
      { type: "paragraph", text: "A small business that manages to borrow from a bank may pay between 20 and 46 per cent a year, while prices rise about 15 per cent. It pays far more for money than prices are rising. And that is the fortunate business. Fewer than one in twenty small businesses can access bank credit at all. The rest rely on family, cooperatives or informal lenders, often for even more." },
      ...
      { type: "paragraph", text: "Now look at where you sit. Your savings pay little because banks can lend to the government at high yields with very low credit risk. Meanwhile the shop down the road, one of the many businesses without bank credit, borrows expensively and puts that cost into its prices. So you earn little on your money and pay dearly when you spend it. You lose at both ends of the same system." },
      ...
      { type: "paragraph", text: "The standard advice is correct and not enough. Track where your money goes, cut the small leaks, build an emergency reserve and clear your most expensive debt first. Some short-term digital loans reach triple-digit annual rates once every fee is counted. If you invest, use regulated institutions, check the firm on the Securities and Exchange Commission register and treat any unusually high promised return as a warning." },
      ...
      { type: "paragraph", text: "Alone, most people cannot buy a productive asset at useful scale. Together, they can. Esusu, ajo and cooperatives have done this for generations. What is usually missing is aiming them at ownership instead of only saving. A hundred people contributing one hundred thousand naira each is ten million naira, enough for a delivery vehicle, grinding machine, cold storage or a shop that collects rent. The group now owns something on the earning side of the economy instead of only the paying side." },
      ...
      { type: "callout", text: "Not financial advice. Figures are drawn from <a href=\"https://www.cbn.gov.ng/MonetaryPolicy/decisions.html\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Central Bank of Nigeria decisions</a>, National Bureau of Statistics releases and the <a href=\"https://www.worldbank.org/en/news/press-release/2025/12/22/world-bank-approves-500-million-to-expand-finance-for-small-businesses-in-nigeria\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">World Bank's MSME finance assessment</a>, current as at August 2026. Verify any firm on the <a href=\"https://sec.gov.ng/for-investors/find-a-registered-operator/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">SEC register</a>. The wider argument is in <a href=\"/writing/effort-at-the-wrong-level\" class=\"link-hover text-accent\">Effort at the Wrong Level</a>." },
    ]
  },
  {
    ...
    content: [
      { type: "paragraph", text: "The six levels in <a href=\"/writing/effort-at-the-wrong-level-part-two\" class=\"link-hover text-accent\">part two</a> all sit inside one economy. This one sits above it. It decides what your country is charged before anybody has looked at a single business inside it, and it is the level people either ignore completely or blame for everything." },
      ...
      { type: "callout", text: "Sovereign borrowing comparisons come from the <a href=\"https://www.oecd.org/en/publications/africa-capital-markets-report-2025_7d26e1d3-en/full-report.html\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">OECD Africa Capital Markets Report 2025</a>, the <a href=\"https://www.undp.org/africa/credit-ratings-resource-platform\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">UNDP Africa Credit Ratings Resource Platform</a>, and <a href=\"https://www.elibrary.imf.org/view/journals/001/2025/139/article-A001-en.xml\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">IMF analysis</a>. Nigerian remittance figures come from Central Bank of Nigeria releases. Current as at August 2026." },
    ]
  },
  {
    ...
    content: [
      { type: "paragraph", text: "Back to Grace and her table, where <a href=\"/writing/effort-at-the-wrong-level\" class=\"link-hover text-accent\">part one</a> left her. Seven levels shape what she earns and only one of them binds at a time. The first six sit inside her own economy, and the first of those is the one she owns outright." },
      ...
      { type: "callout", text: "Kenya agent and commission figures come from Business Daily Africa, the Communications Authority of Kenya, and the Central Bank of Kenya. Nigerian macro figures come from the National Bureau of Statistics and <a href=\"https://www.cbn.gov.ng/MonetaryPolicy/decisions.html\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Central Bank of Nigeria decisions</a>. Agent and terminal rules come from the CBN's <a href=\"https://www.cbn.gov.ng/Out/2025/CCD/CIRCULAR%20AND%20GUIDELINES%20FOR%20THE%20OPERATIONS%20OF%20AGENT%20BANKING%20IN%20NIGERIA%20OCTOBER%206%202025.pdf\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">agent-banking guidelines</a>. Ghana e-levy figures come from ICTD analysis and government revenue targets. Current as at August 2026." },
      { type: "callout", text: "Everything so far happens inside one economy, among people you could go and meet. The last level is different. It sets what your country costs before anyone has looked at your business, and it is decided by people who will never meet you. That is <a href=\"/writing/effort-at-the-wrong-level-part-three\" class=\"link-hover text-accent\">where this ends</a>." },
    ]
  },
  {
    ...
    content: [
      ...
      { type: "callout", text: "That is the whole map. Everything after this is walking it, one level at a time. <a href=\"/writing/effort-at-the-wrong-level-part-two\" class=\"link-hover text-accent\">Start at the bottom</a>, with the level that sits in your own hands." },
    ]
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "When I look back, from student projects to engineering, product, growth and building companies, I find the same two things underneath every breakthrough that mattered. Not intellect. Not strategy. Two quieter traits that arrived before the credentials did." },
      { type: "paragraph", text: "Curiosity and resilience." },
      { type: "paragraph", text: "I consider both gifts from God. I did not manufacture the first impulse to ask or the willingness to continue after failure, but a gift still has to be cultivated. They are not the only ingredients for success. They are the ones I return to when the path is unclear." },
      { type: "quote", text: "Curiosity asks what else this could become. Resilience says we keep going until we find out." },
      { type: "image", url: "/curiosity-and-resilience.png", width: 1254, height: 1254, alt: "Two gifts, infinite impact. Curiosity asks better questions and sees what others miss. Resilience keeps going through the hard moments until breakthrough comes. God gives innovators curiosity and resilience to solve meaningful problems despite every hurdle. Two traits, one purpose, meaningful impact.", caption: "Two traits. One purpose. Meaningful impact." },
      ...
      { type: "paragraph", text: "This is the part people often get wrong. Resilience is not automatically a virtue. You can be dogged in the wrong direction, chasing the wrong opportunity, defending the wrong assumption or repeating a method that has already failed twice." },
      ...
      { type: "paragraph", text: "I have not always continued by doing the same thing. Sometimes it meant learning a new discipline, changing the product, moving closer to the customer or accepting that what worked at one stage had stopped working at the next. The determination to keep moving mattered. So did asking whether I was moving correctly." },
      ...
      { type: "paragraph", text: "But do not neglect the character that determines how you use them." },
      ...
      { type: "paragraph", text: "I remain grateful for every skill, relationship and opportunity God has given me. Knowledge helped me understand. Wisdom helped me judge. Technical depth helped me build. Operational excellence helped me execute. Business acumen helped me create and capture value. Curiosity and resilience kept all of them growing." },
      { type: "paragraph", text: "That is why I hold both as responsibilities, not just advantages. A gift you did nothing to earn is one you have no right to waste. Cultivate it, aim it and spend it on something larger than yourself." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "You cannot reliably set a standard for core work you do not understand, interview for a skill you cannot recognise, or coach an outcome you cannot evaluate. You do not need to outperform every specialist. You need enough command of the work to distinguish excellent, adequate, and quietly failing. Coaching is not encouragement. It is correction with specifics." },
      ...
      { type: "image", url: "/building-teams.jpg", width: 1600, height: 1436, alt: "Tolu Adetuyi beside a progression from building products to building teams and building legacy", caption: "Products create momentum. Teams turn that momentum into an institution." },
  ...
  },
  {
    ...
    ogImage: "/greatness-through-service-og.jpg",
    readingTime: "6 min read",
    content: [
      ...
      { type: "paragraph", text: "Coercion matters, but it does not fully explain this durability. The deeper advantage is being the layer nobody bothers to replace because replacing it is harder than living with it." },
      ...
      { type: "paragraph", text: "China did not become a superpower by competing on price alone. It made the global economy structurally dependent on its factories. It now accounts for roughly 28% of global manufacturing output. In the technologies shaping the next fifty years, the dependence is even sharper. China produces more than 80% of the world's solar panels and battery cells, and around 70% of its electric vehicles. Through its global infrastructure programmes, it also exports the civil engineering behind ports, railways, and power grids." },
      { type: "paragraph", text: "Different stack, same structural logic. The American financial layer and the Chinese industrial layer teach the same lesson. When the world cannot run its daily operations without your output, your leverage becomes difficult to dislodge." },
      ...
      { type: "heading", text: "Macroeconomics is just human behaviour at scale" },
      { type: "paragraph", text: "None of this stays locked at the level of nations. Macroeconomics is human behaviour magnified. The same law that governs the dollar governs your career." },
      ...
      { type: "heading", text: "Continue the work" },
      { type: "paragraph", text: "If you want the real-time version of this thinking, <a href=\"https://zerotoact.com/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">ZeroToAct</a> turns shifts in the global economy into weekly intelligence, an annual summit, and small accountability groups for builders ready to act." },
      { type: "callout", text: "Sources include the <a href=\"https://www.federalreserve.gov/econres/notes/feds-notes/the-international-role-of-the-u-s-dollar-2025-edition-20250718.html\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Federal Reserve's 2025 report on the international role of the US dollar</a> and the IEA's latest data on <a href=\"https://www.iea.org/reports/global-ev-outlook-2026/manufacturing-and-trade\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">electric vehicle and battery manufacturing</a> and <a href=\"https://www.iea.org/reports/energy-technology-perspectives-2026/supply-chain-risks-and-industrial-competitiveness\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">solar supply chains</a>." },
    ]
  },
  {
    slug: "the-wire-transfer-that-never-arrived",
    title: "The Wire Transfer That Never Arrived",
    excerpt: "A few weeks ago I tried to send a routine wire transfer between two U.S. bank accounts. The bank cancelled it. Not for fraud, not for missing funds. My friend happened to be physically in Nigeria. That phone call is the clearest explanation I have of Africa's real infrastructure problem.",
    date: "2026-07-11",
    modifiedDate: "2026-09-10",
    category: "Capital Formation",
    ogImage: "/wire-transfer-og.jpg",
    readingTime: "6 min read",
    content: [
      ...
      { type: "paragraph", text: "The bank never disclosed its risk model. What the call established was that location had become decisive in this transaction. More broadly, fraud and compliance systems often use geolocation and country-risk signals alongside identity and account history. When those signals carry too much weight, a legitimate person can inherit the risk assigned to a place. My friend was not accused of fraud. His location was enough." },
      ...
      { type: "paragraph", text: "<a href=\"https://www.paypal.com/ng/cshelp/article/how-do-i-accept-payments-with-paypal-help217\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">PayPal restricted Nigerian users' ability to receive money for years, and access has only recently widened through a local partner</a>. <a href=\"https://www.thecable.ng/mercury-bank-expands-prohibited-countries-list-to-include-nigeria/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Mercury restricted access for Nigerian founders</a>. A professional who spends a decade building a strong credit profile in Lagos or Accra arrives in London or New York and finds that history did not travel with them. They start at zero, not for lack of merit, but because their financial identity is trapped on the other side of a border. The pattern repeats inside the continent too. It is often easier for an African business to transact with Europe than with a neighbour two borders away. The financial infrastructure Africa inherited was never built for intra-African commerce. It was built to route around it." },
      ...
      { type: "paragraph", text: "Here is where the capital-only story gets tested. <a href=\"https://documents1.worldbank.org/curated/en/099615111172214261/pdf/P17509504ea7b902108a420d5a2e60b19b1.pdf\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Nigeria needs roughly $100 billion in infrastructure investment each year</a>, across power, roads, housing, digital infrastructure, healthcare, and water. That need is beyond what government budgets can meet alone. Private capital must participate. But the same broken infrastructure blocking Africans from transacting with each other also blocks capital from deploying efficiently once it arrives. Capital cannot scale where identity verification is fragile. It cannot compound where payment rails are unreliable. It cannot justify long-duration bets where the grid fails for hours every day. The financing gap and the plumbing problem are not separate challenges. They are the same problem wearing two faces." },
      ...
      { type: "paragraph", text: "I am not writing this as an observer. At Prembly, we have spent years building the identity and trust infrastructure that lets a business or a person carry a verified history across a border instead of starting from zero, or being read as a risk because of where they happen to be standing. That work now runs underneath hundreds of businesses across the continent, including some of its most consequential financial institutions. It is, in the most literal sense, the fix for the exact call I got a few weeks ago. But the plumbing of a continent is integrated. Identity, payments, reliable power, and physical connectivity reinforce each other. None reaches full value alone." },
      { type: "paragraph", text: "Building identity and compliance infrastructure creates evidence that can help capital assess energy and logistics more accurately. This is not a future stack. It is being built layer by layer, and proof at each layer can lower the cost of building the next." },
      { type: "heading", text: "The investment thesis" },
      { type: "paragraph", text: "This is not a call for development aid. Africa has enough people cataloguing its problems. The infrastructure deficit is not a footnote to the growth story. It is the growth story, because every layer that gets built unlocks the one above it. The entry point is identity because it is already proven and helps de-risk what follows. The same conviction extends to payment, energy, and logistics infrastructure. Capital invested in one layer becomes more valuable when the neighbouring layers work." },
      ...
      { type: "paragraph", text: "My friend still has not received that wire transfer. The bank never reversed its decision. That phone call remains the clearest and most honest description I have of both the problem and the opportunity. A system able to weigh his identity and account history properly might have treated location as a fact rather than a verdict. The pipes will be fixed. The infrastructure will be built. The only real questions left are who builds it, who funds it, and who is at the table when it starts to work." },
    ]
  },
  {
    slug: "lazy-thinking-is-killing-your-company",
    title: "Lazy Thinking Is Killing Your Company",
    excerpt: "You review a piece of work that came back flat. You push once, twice, a third time. The same person produces something excellent. Their ability did not change. The standard did. That should disturb you more than it does.",
    date: "2026-07-10",
    modifiedDate: "2026-09-10",
    category: "Leadership",
    ...
    content: [
      ...
      { type: "paragraph", text: "Their ability did not change. The standard did. That should disturb you more than it does." },
      { type: "image", url: "/lazy-thinking.png", width: 1254, height: 1254, alt: "Lazy Thinking is Killing Your Organization. Most organizations do not have a people problem. They have a thinking problem.", caption: "Most organizations do not have a people problem. They have a thinking problem." },
      ...
      { type: "paragraph", text: "The science on this is old and unflattering. <a href=\"https://www.nobelprize.org/uploads/2018/06/simon-lecture.pdf\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Herbert Simon showed that people do not optimise, they satisfice</a>. We settle for the first option that clears the bar of acceptable, then stop searching. Psychologists <a href=\"https://www.sagepub.com/shop/buy-a-book/social-cognition-4-269580\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Susan Fiske and Shelley Taylor described humans as cognitive misers</a>. Deep thinking takes attention, so people conserve it and use shortcuts unless the environment demands more. <a href=\"https://www.sciencedirect.com/science/article/pii/002210317490033X\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Ringelmann's research found that individual effort can shrink when contribution becomes hard to see</a>." },
      ...
      { type: "paragraph", text: "Which explains the founder effect. When you step in and push, you are not adding intelligence to the room. You are adding scrutiny. <a href=\"https://pubmed.ncbi.nlm.nih.gov/3572733/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Philip Tetlock's research on accountability</a> found that people reason more carefully and self-critically when they expect to justify their conclusions to someone whose views they cannot predict. Your presence changes the expected audience for the work. The person was always capable of the deeper version. They simply calculated, correctly, that the shallow version would be accepted." },
      ...
      { type: "paragraph", text: "Every time <a href=\"/writing/everything-made-in-one-shot-has-a-look\" class=\"link-hover text-accent\">surface work</a> passes review, the organisation teaches everyone watching what the actual standard is, regardless of what the values deck says. Your real quality bar is not what you preach. It is the worst work you consistently approve." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/three-core-skills.png", width: 1254, height: 1254, alt: "Infographic titled The Three Core Skills, From Insight to Impact. Ideation reads the market, validates the problem, has taste. Elucidation does the deep research, maps the unfamiliar terrain, produces the how. Implementation takes a clear path and builds it fast, cleanly, and can teach it forward.", caption: "Different skills. Different roles. Same mission, build solutions that matter." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/dispute-success.png", width: 1170, height: 1493, alt: "Mobile app screenshot showing a dispute timeline: Dispute pending (Jun 13), Dispute submitted (Jun 19), Dispute in preparation (Jun 19), Dispute raised to the merchant (Jun 19), Dispute successful (Jun 25) — with the note: We have won your dispute request and your charge has already been refunded to your account.", caption: "Jun 25. The outcome of submitting what I had." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/delegation.png", width: 1254, height: 1254, alt: "Delegation framework illustrating the shift from founder as engine to founder as ecosystem architect", caption: "Stop planting every seed. Start designing the soil." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/energy-impact-matrix.png", width: 1600, height: 1603, alt: "The Energy-Impact Matrix: a 2x2 grid mapping problem difficulty against personal energy. Zone 1 (hard, energizing) is your problem domain. Zone 2 (hard, draining) is high burnout risk. Zone 3 (simple, energizing) is maintenance. Zone 4 (simple, draining) should be delegated.", caption: "Focus your energy. Multiply your impact." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/young-africans.png", width: 1600, height: 1598, alt: "Infographic: Stop Asking For Anything. Pick Something Specific. A funnel diagram showing scattered effort narrowing to a focused target, with four steps: Explore, Choose, Focus, Execute.", caption: "Why clarity creates opportunities that desperation never sees." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/power-grid.png", width: 1024, height: 1536, alt: "The 3 Stages of Integrated Power: Spirit, Soul, and Body", caption: "A fully integrated person keeps their spirit, soul, and body in sync—so what flows through them is consistent, reliable, and impactful." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/execution.png", width: 1024, height: 1536, alt: "The 4-Step Execution Framework", caption: "From uncertainty to clarity. Build what matters. Fast." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/progress.png", width: 1024, height: 1536, alt: "The 5 Mindsets of Real Progress", caption: "From blaming the world to building the future. This is the shift from powerless to powerful." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/iso-20022-payment-layers.jpg", width: 1024, height: 682, alt: "ISO 20022 Payment Message structure showing the four layers: Core Transaction, Intent and Purpose, Identity and Entity, and Life-Cycle Traceability", caption: "The four layers of an ISO 20022 payment message. Source: Prembly" },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "image", url: "/closed-loop-trust-system.jpg", width: 1024, height: 1024, alt: "The Closed-Loop Trust System diagram", caption: "Five questions every serious fintech should constantly ask about their customers." },
