...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Most conversations about Africa's economy start with the wrong metrics. We talk about capital requirements and financing gaps, and both are real, but they obscure the deeper failure. Africa's primary constraint is not a lack of capital. It is the absence of infrastructure that lets capital move, get verified, and get deployed once it arrives." },
      ...
      { type: "paragraph", text: "Layer the investment problem on top and the picture sharpens. Nigeria alone faces an annual infrastructure financing gap of roughly $170 billion, across power, roads, housing, digital infrastructure, healthcare, and water. That gap is documented, growing, and beyond what government budgets can close alone. Private capital has to fill it. What most analyses skip is that the same broken infrastructure blocking Africans from transacting with each other also blocks capital from deploying efficiently in Africa. Capital cannot scale where identity verification is fragile. It cannot compound where payment rails are unreliable. It cannot justify long duration bets where the grid fails for hours every day. The financing gap and the plumbing problem are the same problem wearing two faces." },
      { type: "heading", text: "Building the stack" },
      { type: "paragraph", text: "Fixing this takes more than one policy fix or one standout company. It takes a coordinated stack, built in order. Identity comes first, because nothing moves without trust, and African businesses need the ability to carry their history across borders instead of starting over at every one. Payment rails come next, so value can move across African corridors and into global trade without a mandatory detour through New York or London. Energy and physical connectivity sit underneath both, because no digital economy compounds on a grid that fails every few hours. Capital formation sits above all of it, patient vehicles built to absorb long duration infrastructure risk and return something real. Pull out any one layer and the whole stack underperforms. Build them in sequence and you get a continent that compounds." },
      { type: "heading", text: "Writing from inside the work" },
      { type: "paragraph", text: "I am not writing this as an observer. At Prembly, we have spent years building the trust infrastructure that lets businesses verify each other and their global counterparts, now serving hundreds of businesses across the continent, including some of its most consequential financial institutions. That work sits at the identity layer of the stack. But the plumbing of a continent is one integrated system, and you cannot scale a digital economy on a flickering grid. Whether it is the $1.1 billion needed to close Nigeria's electricity deficit or the rail links that move physical trade, these are not separate problems. They are the same problem of coordination and capital, one layer up." },
      ...
      { type: "paragraph", text: "This is not a call for development aid. Africa has enough people cataloging its problems. Africa's infrastructure deficit is the defining investment thesis of the next two decades, and the investors who recognize that early will not just earn outsized returns. They will shape the trajectory of the world's youngest, fastest growing continent." },
      ...
      { type: "paragraph", text: "My friend still has not received that wire transfer. The bank never reversed its decision. That phone call remains the clearest and most honest description I have of both the problem and the opportunity. It would have cleared in seconds if verified identity were portable and decoupled from a single geography. The pipes will be fixed. The infrastructure will be built. The only real questions left are who builds it, who funds it, and who is at the table when it starts to work." },
    ]
  },
  {
