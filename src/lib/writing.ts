...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "My output stopped being what I personally produced. The question became whether dozens of people could do work I would be proud to put my name on when I was not in the room, and keep doing it next quarter while I was somewhere else. I had years of practice making myself better and almost none making anybody else better." },
      { type: "paragraph", text: "Starting my own company removed the last places to hide. Inside a larger organisation, you can lean on a structure, brand, and processes someone else built. As a founder, whatever the team becomes is something you either designed or allowed to happen." },
      ...
      { type: "paragraph", text: "<strong>Write down who decides what.</strong> Not an org chart. A decision list showing what a lead decides alone, what needs a peer, what comes to me, and the threshold in naira, risk, or customer impact. People escalate when guessing feels more dangerous than asking." },
      ...
      { type: "paragraph", text: "<strong>Measure yourself by what happens without you.</strong> I watch which decisions reached me that should not have and how many people we promoted from inside. When I travel for two weeks, whatever broke is my report card, not theirs." },
