...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "<strong>The first is that your first version does not get published.</strong> It gets three passes before anybody sees it. This is not perfectionism. Perfectionism has no exit, it keeps you circling because you are afraid of being judged. A rule with a number tells you when you are allowed to stop. Three passes and out, unless a pass uncovers something structurally broken, in which case that pass does not count and you go again." },
      ...
      { type: "paragraph", text: "The video in this piece is the example. Four rounds before it was worth showing. The tool did the animating every time, and not once did it decide that the subject should be one poster made twelve times, or that the compounding should be shown as two lines pulling apart rather than said in a sentence. Those were my calls, and they are the only reason the thing is about anything. Take them out and you have another competent video about excellence that nobody needed." },
