...
const posts: Post[] = [
  {
    ...
    excerpt: "I have built my operating philosophy around a simple idea: move. Then a $39 charge reminded me I was still capable of forgetting it entirely.",
    date: "2026-06-27",
    category: "Execution",
    readingTime: "4 min read",
    content: [
      { type: "paragraph", text: "I have built my operating philosophy around a simple idea: move. Do not wait for perfect conditions. Do not stall behind the illusion of preparation. When something needs doing, do it." },
      ...
      { type: "paragraph", text: "I carried that low-grade annoyance around for days before I finally filed a dispute. The process was not friendly. They wanted documentation. A cancellation confirmation email. I went through my inbox. Nothing. No clean record of what I had done. I had my certainty and not much else." },
      { type: "paragraph", text: "I was close to walking away. Then I thought: just submit what you have." },
      { type: "paragraph", text: "So I did. Bundled up whatever fragments I could find, hit submit without much hope, and forgot about it." },
      ...
      { type: "paragraph", text: "Because here is what I had done: I delayed filing a legitimate claim because I was waiting for evidence I did not have. I was building a case in my head for a dispute I had not started. And if I had kept waiting, the outcome would have been decided for me, quietly, by default." },
      ...
      { type: "paragraph", text: "Fear of looking foolish. Fear of trying and being told no. Fear of putting something forward that is not airtight." },
      { type: "paragraph", text: "The $39 made this obvious because the stakes were low. But I have watched the same pattern play out at much higher cost. Founders who did not launch because the product was not ready enough. Operators who sat on decisions because the data was not complete enough. Professionals who did not raise their hand because the moment was not right enough. The amounts change. The mechanism stays the same." },
      ...
      { type: "heading", text: "The only two things that happen when you move" },
      { type: "paragraph", text: "Action is not a guarantee of success. Anyone telling you otherwise is selling something." },
      { type: "paragraph", text: "But here is what inertia actually costs. When you do not move, nothing happens. No data. No feedback. No adjustment. The situation does not hold still while you think. It moves without you." },
      { type: "paragraph", text: "When you move, even with incomplete information, even with imperfect evidence, even before you feel ready, the world responds. Sometimes that response is a win. Sometimes it is a fast failure that teaches you something real. Both are infinitely more useful than standing still." },
