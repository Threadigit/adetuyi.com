...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "But some Zone 2 problems are structural. If the drain is coming from the fundamental nature of what that industry, organization, or team needs every day, no amount of internal negotiation will fix it. The role requires a Zone 2 operator and you are not one. That is when you stop optimizing the configuration and start planning the migration. The move is almost never sudden. You build the bridge before you burn the one you are standing on. You take on work in your Zone 1 domain wherever you can find the surface area. You find the people already operating where you want to go and make yourself useful to them. You transition into it gradually, before you formally leave, so that when you do make the move you arrive with momentum instead of desperation." },
      { type: "heading", text: "Your zones will shift" },
      { type: "paragraph", text: "One last thing worth naming. What fills Zone 1 at twenty-two is usually about raw execution. The problem is right in front of you and you want to solve it directly, with your own hands. You want to write the code, close the deal, build the thing. The energy comes from the contact sport of it." },
      { type: "paragraph", text: "By thirty-two, something else tends to emerge. The puzzle that starts pulling you in is no longer just the technical or operational challenge itself. It is the question of how to build the conditions where other people can solve problems at scale. How to hire for the right energy type. How to architect an organization the same way you once architected a system. The abstraction level shifts, and if you are paying attention, so does your Zone 1." },
      { type: "paragraph", text: "That is not a loss. It is a signal that your range has expanded. The flavor of mess you find fascinating has moved up a level. Pay attention to that shift when it comes, because grinding at the execution level you have outgrown is exactly how capable people burn out in roles they used to love." }
    ]
  },
  {
