...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "I was a software engineer. Someone brought a problem, I broke it into parts, designed a solution, wrote the code, tested it, and shipped it. If I stayed after everyone had gone home, the commit history showed it. If I spent a weekend learning a new framework, Monday moved faster. If I picked up the ugly bug nobody wanted, people noticed by Friday." },
      { type: "paragraph", text: "The more I did, the brighter I looked. That is the starboy model. Your value is easy to see because your hands are on the output." },
      { type: "paragraph", text: "I did not understand how rare that arrangement was until I lost it." },
      ...
      { type: "paragraph", text: "My output stopped being what I personally produced. The question became whether dozens of other people could do work I would be proud to put my name on when I was not in the room, and whether they could keep doing it next quarter while I was somewhere else entirely." },
      { type: "paragraph", text: "Nothing in my training had prepared me for that question. I had years of practice making myself better and almost none making anybody else better." },
      { type: "paragraph", text: "Starting my own company did not create the problem. It removed the last places to hide from it. Inside a larger organisation, you can lean on a structure someone else built, a brand that recruits on your behalf, and processes you inherited without ever having to justify them. As a founder, nothing is inherited. Whatever the team becomes, you either built it deliberately or allowed it to happen." },
      { type: "paragraph", text: "Software behaves the way you designed it. People do not. Software does not resign on a Tuesday because nobody explained what good looked like. It does not stop raising problems because the last person who spoke up was embarrassed in a meeting. It does not carry the weight of a hard year at home into a sprint review. I had spent years mastering a system that was logical, and I now owned one that was not." },
      ...
      { type: "paragraph", text: "The story people expect is that I held on too long and became a bottleneck. That came later. My first mistake was the opposite, and it was more dangerous because it looked so much like maturity." },
      { type: "paragraph", text: "I had read enough about founders working on the business rather than in it that I tried to graduate early. I wanted out of support tickets, difficult customer calls, and operational detail. So I looked for people to hand things to before I had done those things well enough to know what a good handover required." },
      { type: "quote", text: "That is not delegation. It is abdication with a job title." },
      { type: "paragraph", text: "You cannot set a standard you have never reached. You cannot interview for a skill you cannot recognise in the room. You cannot coach work you have never done because coaching is not encouragement. It is correction with specifics. Founders often struggle with their first senior hires because they skipped the season when they needed to know the work in their bones. They hire a title, hope for magic, and have no basis for deciding whether what comes back is excellent, adequate, or quietly failing." },
      { type: "paragraph", text: "The early mess is not a phase to survive. It is where intuition is manufactured. Build the first version. Sit in support. Close the first partnerships yourself. Do the reconciliation by hand once so you understand what breaks. That knowledge becomes the basis for telling a talented person that good work is not yet good enough, and explaining exactly why." },
      { type: "paragraph", text: "The second mistake came after I had learned the first lesson properly. I stayed. I kept reviewing designs, approving decisions, and sitting in meetings that ran better without me. It felt like service. It was a ceiling. Every decision that only you can make limits how fast the organisation can move, and the limit tightens as you grow." },
      { type: "paragraph", text: "Delegating before you understand the work and refusing to delegate after you understand it look like opposite mistakes. They are the same error at different moments. The real skill is timing." },
      ...
      { type: "paragraph", text: "Moses had become the bottleneck of a nation. Every dispute came to him. People stood in line from morning until evening waiting for one man. His father-in-law watched for a day and said something I have never been able to unhear. What you are doing is not good." },
      { type: "paragraph", text: "Jethro did not question whether Moses was capable, righteous, or hardworking. He questioned the architecture. The man was fine. The design was wrong." },
      { type: "paragraph", text: "His answer was more precise than the usual advice to delegate more. Select capable people with clear character requirements. Place them over thousands, hundreds, fifties, and tens. Let them handle routine matters at their level. Escalate only the difficult cases. Teach people the statutes so fewer disputes arise in the first place." },
      { type: "paragraph", text: "That is span of control, decision rights, an escalation path, a hiring standard, and a documentation strategy described millennia before anyone charged a consulting fee for it. Moses did not become less responsible. His work changed shape." },
      { type: "paragraph", text: "The pattern appears again in Acts 6. The early church grew, operations multiplied, and a real complaint emerged about people being overlooked in the daily distribution. The apostles did not absorb the function or dump it on whoever was available. They defined a standard, selected seven respected people, and handed over the work so they could remain focused on what only they could do. They became more precise about where each person's time created the most value. The text records what followed. The word spread and the number of disciples increased." },

      { type: "heading", text: "Delegation is only the first half" },
      { type: "paragraph", text: "Most founders daydream about delegation. I cannot wait to hire someone for this. I have said it myself." },
      ...
      { type: "paragraph", text: "Nicholas Bloom and his colleagues ran a <a href=\"https://www.gsb.stanford.edu/faculty-research/publications/does-management-matter-evidence-india\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">randomised field experiment with textile firms in India</a>. They gave management consulting to a randomly selected group of plants and compared them with a control group. Productivity rose by 17 percent in the first year, and within three years the treated firms were opening additional plants." },
      { type: "paragraph", text: "The important lesson for founders is why growth had been constrained. Managerial time was limited, decision-making was highly centralised, and owners were reluctant to delegate work they could not monitor. Better information and management practices reduced the need for direct supervision. Delegation became safer, and expansion became possible." },
      { type: "quote", text: "The constraint was not demand alone. It was the number of decisions the owner could personally supervise." },
      { type: "paragraph", text: "Google found a related pattern through <a href=\"https://hbr.org/2013/12/how-google-sold-its-engineers-on-management\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Project Oxygen</a>. After studying thousands of comments, performance reviews, and employee surveys, it identified eight behaviours shared by effective managers. Coaching ranked first. Technical expertise ranked eighth." },
      { type: "paragraph", text: "That did not mean technical ability was irrelevant. At Google, it was already expected. It simply did not separate the strongest managers from the rest. The differentiating work was coaching, communication, empowerment, and helping other people perform." },
      { type: "paragraph", text: "The studies come from different industries and answer different questions, but they point in the same direction. Management is not a personality trait you discover after promotion. It is a set of practices that can be taught, measured, and improved." },
      ...
      { type: "paragraph", text: "<strong>Write down who decides what.</strong> Not an org chart. A decision list. Which calls a lead makes alone, which need a peer, which come to me, and what the standing threshold is in naira, risk, or customer impact. Many founder bottlenecks are not control problems. They are undefined authority. People escalate because escalating is safer than guessing." },
      { type: "paragraph", text: "<strong>Define good before hiring for it.</strong> Write one page per role describing excellent output, mediocre output, and the three things this person must do without help by month three. If I cannot write that page, I am not ready to hire. I am ready to hope." },
      { type: "paragraph", text: "<strong>Teach through decisions.</strong> When a consequential decision is made, explain the reasoning behind it. Walk the team through the customer problem, the architectural decision and its trade-offs, why a particular customer matters to the business, why one issue is urgent while another can wait, and the principles and best practices that shaped the choice. People develop judgement when they can follow the thought process, not when they only see the outcome. Share the reasoning that worked and the reasoning you later had to revise." },
      { type: "paragraph", text: "<strong>Protect the one-on-one from status updates.</strong> Status belongs in writing. That conversation is for the person, their growth, the issue they are avoiding, and the feedback I owe them. The moment it becomes a progress report, I lose the recurring space where leaders are actually built." },
      { type: "paragraph", text: "<strong>Measure yourself by what happens without you.</strong> I watch how many decisions reached me that should not have. I watch how many people we promoted from inside. When I travel for two weeks, whatever broke is my report card, not theirs." },
      ...
      { type: "paragraph", text: "If the founder stops learning, the company eventually plateaus. If the founder avoids hard conversations, the culture learns that avoidance is acceptable and spreads it faster than any value written on a wall. Your rate of learning sets the ceiling for the people hired under you." },
      { type: "paragraph", text: "So my reading changed. Leadership, organisational design, finance, negotiation, hiring, capital, and Scripture. I went back for an MBA in the middle of running companies, not because I needed the certificate, but because the tools of my trade had changed. I refused to keep operating with instincts formed in a season that had already closed." },
      ...
      { type: "paragraph", text: "I still love building. I will probably always open an editor at some point in the week just to feel something compile." },
      { type: "paragraph", text: "But I no longer measure my contribution by what I personally shipped. I measure it by how many people can now make a decision I would have made, and by what would still stand if I walked away tomorrow." },
