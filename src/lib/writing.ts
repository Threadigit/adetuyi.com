...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "That is the architecture of leverage. Design the soil. Cast the vision precisely enough that it becomes a compass. Resource your people properly. Get into the trenches when it counts. Then watch what they build." },
    ]
  },
  {
