...
const posts: Post[] = [
  {
    ...
    content: [
      { type: "paragraph", text: "We are not paralyzed by a lack of vision. We are paralyzed by the scale of it." },
      { type: "paragraph", text: "The problem is rarely that people cannot see where they want to go. Many can see it with uncomfortable clarity. They know the company they want to build, the problem they want to solve, the life they want to create, the impact they want to have. The problem is that they are standing at level one while mentally living at level fourteen. They keep staring at the final stage and wondering how to reach it." },
      ...
      { type: "paragraph", text: "Every young African understands this better than most management books ever will. Two stones become goalposts. A pair of schoolbags marks the other end. The ball is half plastic, half faith. The pitch is rough asphalt, loose sand, or grass that gave up years ago. None of it matters. The match starts anyway." },
      ...
      { type: "paragraph", text: "Psychologists call part of this Behavioral Activation. Action creates clarity. Many people assume clarity produces action. The opposite is often closer to the truth. Movement unlocks information that thinking alone cannot access. You do not think your way into readiness. You act your way into readiness." },
      { type: "paragraph", text: "The entrepreneur and scholar Saras Sarasvathy spent years studying experienced founders and discovered a similar pattern. The best builders rarely begin with complete plans. They begin with available means. They start with who they are, what they know, and who they know. Then the destination sharpens through movement. Not because they lack vision. Because reality reveals itself to people in motion." },
      ...
      { type: "paragraph", text: "This is why curiosity and resilience matter so much. Curiosity keeps you in the room long enough to learn. Resilience keeps you in the room long enough to benefit from what you learned. Together they create what every builder needs: a place where failure is information, experimentation is normal, and mistakes become assets instead of verdicts. That posture is developed in the early levels. Not the later ones." },
      { type: "heading", text: "The settle" },
      { type: "paragraph", text: "The traditional Igbo apprenticeship system understood this long before modern entrepreneurship did. A young apprentice starts with almost nothing. No capital. No customers. No storefront. Only access. For years he learns the trade from the inside. He observes. He serves. He practices. He earns trust. Then comes the settle. The oga releases resources for the next stage. Capital. Relationships. Inventory. Opportunity. The resources arrive after demonstrated capability. Not before. That is not merely tradition. It is a description of how progress works." },
      { type: "paragraph", text: "Faith, in the context of building, is not believing that everything will magically work out. Faith is believing that the next level contains resources you cannot yet see. Faith is trusting that execution reveals what observation never can. Faith is understanding that the map expands as you move. The apprentice is settled. The scout eventually arrives. The upgrade eventually appears. But only for the player who is actually playing." },
      { type: "paragraph", text: "You do not need the full map. You need enough clarity for the level in front of you. If your vision feels overwhelming today, stop measuring yourself against level fourteen. Look at what is already in your hands. Two stones can be a goalpost. A plastic ball can start a match. A single customer can become a company. A single line of code can become a platform. A single step can become a movement. The next level is not unlocked by understanding it. The next level is unlocked by completing the one you are standing in." }
    ]
  },
  {
