...
const posts: Post[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Use one test as you read. <strong>If the thing you are blaming vanished tomorrow, could you actually move?</strong> If not, it is real but it is not your binding constraint. Something beneath it is." },
      ...
      { type: "heading", text: "Part one. The seven levels" },
      ...
      { type: "paragraph", text: "Nigeria has roughly two million banking agents and 8.36 million registered POS terminals, moving 10.51 trillion naira in the first quarter of 2025 alone. In October 2025 the central bank ruled that agents must become exclusive to a single principal, with implementation from 1 April 2026. Many had deliberately spread across two or three networks so one outage would not close them for the day. One document required an entire market to change how it operated." },
      ...
      { type: "heading", text: "Part two. How influence moves" },
      ...
      { type: "heading", text: "Part three. Find the binding constraint" },
      ...
      { type: "paragraph", text: "Return to the test. Give Grace a policy rate of zero and she is still capped by a hundred-naira fee on a street with three other agents. The rate was real. It was not what was holding her. Run the same question on whatever you have been blaming. If removing it would not free you, look beneath it." },
      ...
      { type: "callout", text: "Sources include Business Daily Africa and the Communications Authority of Kenya for agent economics; the <a href=\"https://www.cbn.gov.ng/MonetaryPolicy/decisions.html\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">Central Bank of Nigeria</a> for monetary policy; the CBN's <a href=\"https://www.cbn.gov.ng/Out/2025/CCD/CIRCULAR%20AND%20GUIDELINES%20FOR%20THE%20OPERATIONS%20OF%20AGENT%20BANKING%20IN%20NIGERIA%20OCTOBER%206%202025.pdf\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"link-hover text-accent\">agent-banking guidelines</a>; ICTD for Ghana's e-levy; and OECD, UNDP, IMF and Africa Finance Corporation reports on sovereign borrowing. Current as at August 2026." },
    ]
  },
  {
