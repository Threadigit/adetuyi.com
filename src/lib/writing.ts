...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "I spend my days on the stuff people call building the future. Trust systems, capital, scale. Meanwhile another world has been quietly raising my daughter from the inside, and I only noticed recently." },
      ...
      { type: "paragraph", text: "I don't have the balance worked out yet. What does a system look like that keeps her fully human and still ready for a world this digital? If you've got a better answer than mine, I want to hear it. Hit me up. Send me a note." },
    ]
  },
  {
    slug: "the-39-dispute",
