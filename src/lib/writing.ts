...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "<strong>Now the part that has to come from you.</strong> Both rules are refinement, and refinement has no direction of its own. Passes make a thing sharper. They cannot tell you what it should have been. What they are sharpening is a position, a view of the thing that somebody could disagree with. Not novelty, and not style. A decision about what this is for and what it is arguing. The passes have nothing to work on until that exists." },
      { type: "paragraph", text: "You can feel where it is missing. The deck that anyone with the same five references would have produced. The strategy memo that lands exactly where the room already stood. The sermon that says a true thing in the order it is always said. None of it is wrong. It is just nobody's." },
      { type: "paragraph", text: "It shows up as subtraction more than addition. What you lead with, what you cut, the obvious line you refuse to write because everybody writes it. So put one question before the three passes. What in this could only have come from me. If the honest answer is nothing, you have assembled the thing rather than made it, and more passes will only sharpen somebody else's point." },
      ...
      { type: "paragraph", text: "Come with a position somebody could disagree with. Three passes before it ships. Every repetition better than the last one. Bank what you learn so the next person starts where you stopped." },
