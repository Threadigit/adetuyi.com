...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Alone, most people cannot buy anything that generates income. Together, they can. Esusu, ajo and cooperatives have done this for generations. What is usually missing is aiming them at ownership instead of only at saving. A hundred people contributing twenty thousand naira each is two million naira, enough for a delivery vehicle, a grinding machine, cold storage, or a shop that collects rent. The group now owns something on the earning side of the economy instead of only the paying side." },
