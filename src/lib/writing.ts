...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "<strong>Teach in the open.</strong> When I do the work now, I narrate why. Why this customer. Why this pricing. Why we walked away. People cannot inherit judgement by watching outcomes. They inherit it by hearing the reasoning repeatedly, including the reasoning that turned out to be wrong." },
