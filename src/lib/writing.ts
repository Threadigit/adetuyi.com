...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "<strong>Then the part no process can give you.</strong> Both rules are refinement, and refinement has no direction of its own. Three passes on something that did not need to exist gets you a tidy version of something that did not need to exist. What has to come from you is a position, a view of the thing that somebody could disagree with. Not novelty, and not style. A decision about what this is for and what it is arguing, which is the one input the passes are refining." },
