    ...
    <main className="max-w-[680px] mx-auto px-6 py-16 md:py-24">
      ...
      <article className="animate-fade-up">
        ...
        <div className="prose prose-slate prose-p:leading-[1.85] prose-p:text-[15px] prose-p:text-muted prose-strong:text-foreground prose-strong:font-medium prose-a:text-accent prose-a:no-underline hover:prose-a:underline max-w-none">
          ...
          <p>
            I am already testing this model at a small scale through productive
            electric assets, battery operations, structured repayments, and
            software monitoring. The work is early and does not yet prove
            portfolio-level economics. Its value is practical. It allows me to
            measure station utilisation, battery life, maintenance cost,
            collection behaviour, load patterns, and the revenue generated by
            each unit of invested capital. Those results will determine whether
            the model is ready for infrastructure financing at scale.
          </p>
